    ...
    <div class="ui two column very relaxed grid">
        <div class="five wide column">
            ...
            <form class="ui form" method="POST" action="/boardnames">
                @csrf
                <div class="field">
                    <input class="input {{ $errors->has('boardname') ? 'is-danger' : '' }}" type="text" name="boardname"
                        value="{{ old('boardname') }}" placeholder="보드 명" required>
                </div>
                ...
                <div class="field">
                    <input class="input {{ $errors->has('man_hour') ? 'is-danger' : '' }}" type="number" name="man_hour"
                        value="{{ old('man_hour') }}" placeholder="공수">
                </div>
            ...
            <table class="ui celled table">
                ...
                <thead>
                    <tr>
                        ...
                        <th>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">보드명</font>
                            </font>
                        </th>
                        <th>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">TOP 부품수량</font>
                            </font>
                        </th>
                        <th>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">BOT 부품수량</font>
                            </font>
                        </th>
                        <th>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">공수(분)</font>
                            </font>
                        </th>
                        <th>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">TOP소재</font>
                            </font>
                        </th>
                        <th>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">BOT소재</font>
                            </font>
                        </th>
                        <th>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">메탈마스크넘버</font>
                            </font>
                        </th>
                        <th>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">도면넘버</font>
                            </font>
                        </th>
                        <th>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">방법</font>
                            </font>
                        </th>
                        <th>
                            <font style="vertical-align: inherit;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">{!! $boardname->top_num!!}</font>
                            </font>
                        </td>
                        <td>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">{!! $boardname->bot_num!!}</font>
                            </font>
                        </td>
                        <td>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">{!! $boardname->man_hour!!}</font>
                            </font>
                        </td>
                        <td>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">{!! $boardname->top_method!!}</font>
                            </font>
                        </td>
                        <td>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">{!! $boardname->bot_method!!}</font>
                            </font>
                        </td>
                        <td>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">{!! $boardname->metal_mask_no!!}</font>
                            </font>
                        </td>
                        <td>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">{!! $boardname->dwg_no!!}</font>
                            </font>
                        </td>
                        <td>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">{!! $boardname->method!!}</font>
                            </font>
                        </td>
                        <td>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">{!! $boardname->note!!}</font>
                            </font>
                        </td>
                    </tr>
                    @endforeach
            ...
            <div class="ui grid">
                <div class="row">
                    <div class="six wide column">
                        ...
                        <div class="item">
                            <form method="get" action="/boardnames/" id="frm2">
                                @csrf
