    ...
    <div class="row">
        ...
        <div class="column">
            ...
            <div class="field">
                ...
                <div class="ui input">편성<input type="text" name="set_set" value="{{ $set_set }}"></div>
        ...
        {{--  <div class="column">  --}}
            <div> <a href="/toto/{{$shipment_name_choice}}/{{$start_date}}/{{$end_date}}" class="ui teal button">엑셀파일
                    다운로드</a></div>
        {{--  </div>  --}}
