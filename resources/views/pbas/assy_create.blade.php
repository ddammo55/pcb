...
<form class="ui form" method="POST" action="/assys/assy_create" enctype="multipart/form-data">
  ...
  <div class="field">
	...
	<div class="field">
		<input class="input {{ $errors->has('assy_name') ? 'is-danger' : '' }}" type="text" name="assy_name" value="{{ old('assy_name') }}" placeholder="제품명" required>
	</div>

  <input type="hidden" name="division" value="ASSY">
